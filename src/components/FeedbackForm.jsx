...
const FeedbackForm = ({ onSubmit }) => {
  ...
  const validate = () => {
    ...
    if (!form.visitFrequency) errs.visitFrequency = 'Please select how often you visit.';
    if (!form.recommend) errs.recommend = 'Please indicate if you would recommend us.';
    return errs;
  };
      ...
      <div className="bg-white shadow-md rounded-lg w-full max-w-sm p-4 space-y-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            {errors.visitFrequency && <p className="text-red-500 text-sm">{errors.visitFrequency}</p>}
          </div>
